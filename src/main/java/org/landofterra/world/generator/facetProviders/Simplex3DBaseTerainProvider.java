...
public class Simplex3DBaseTerainProvider implements FacetProvider {
    ...
    public Simplex3DBaseTerainProvider(){
    ...
    public Simplex3DBaseTerainProvider(int seedOffSet,Vector3f zoom,int octaves,double modulus, double multificator,double increase){
    	this.zoom=zoom;
