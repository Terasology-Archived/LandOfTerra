...
public class Perlin3DBaseTerainProvider implements FacetProvider {
    ...
    public Perlin3DBaseTerainProvider(){
    ...
    public Perlin3DBaseTerainProvider(int seedOffSet,Vector3f zoom,int octaves,double modulus, double multificator,double increase){
    	this.zoom=zoom;
